...
function calculateResAmounts(wood, stone, iron, warehouse, merchants) {
    ...
    var totalAvailableRes = localWood + localStone + localIron;
    var perc = merchantCarry / totalAvailableRes;
    if (perc > 1) perc = 1;

    thisVillaData = { 
        "wood": Math.floor(localWood * perc), 
        "stone": Math.floor(localStone * perc), 
        "iron": Math.floor(localIron * perc) 
    }
