...
ap.innerHTML += "<br/><br/><br/><div align='center'><font size='1' face='Comic Sans MS' color='purple'><a href='https://forum.klanlar.org' target='_blank'>Klanlar Forum</a>'na uğradın mı?</font></div>";
...
function casus() {
  if (dcasus.checked == true) {
    dcasusf.color = 'green';
    dortamesaj.innerHTML = 'Her saldırının yanında 1 casus göndereceksin.';
    daltta.value = "";
  }
  if (dcasus.checked == false) {
    dcasusf.color = 'dimgray';
    dortamesaj.innerHTML = 'Casus mu? Boşver...';
    daltta.value = "";
  }
}
...
function uyar() {
  if (duyar.checked == true) {
    duyarf.color = 'green';
    dortamesaj.innerHTML = 'Artık son koordinata geldiğinde script seni uyaracak.';
    daltta.value = "";
  }
  if (duyar.checked == false) {
    duyarf.color = 'dimgray';
    dortamesaj.innerHTML = 'Uyarıyı kapattın, tekrar düşün...';
    daltta.value = "";
  }
}
...
function Konsantre() {
  ...
  if (dbirim.value == 'b1') {
    if (dcasus.checked == false && duyar.checked == false) {
      var sson = "80123.js');";
    }
    if (dcasus.checked == true && duyar.checked == false) {
      var sson = "80234.js');";
    }
    if (duyar.checked == true && dcasus.checked == false) {
      var sson = "80345.js');";
    }
    if (duyar.checked == true && dcasus.checked == true) {
      var sson = "80456.js');";
    }
    daltta.value = silk + sson;
  }
  if (dbirim.value == 'b2') {
    if (dcasus.checked == false && duyar.checked == false) {
      var sson = "90123.js');";
