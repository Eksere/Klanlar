...
$.getAll(
    ...
    () => {
        ...
        let html = `
            <div>
                <h2>Kasılan Premium Puanlar</h2>
                <table class="vis" width="100%">
                    <tr>
                        <th>Tarih</th>
                        <th>Miktar</th>
                    </tr>
                    ${farmed.map(f => `<tr><td>${f.Date}</td><td>${f.Amount}</td></tr>`).join('')}
                </table>
                <h3>Toplam: ${totalFarmed} PP</h3>

                <h2>Harcanan Premium Puanlar</h2>
                <table class="vis" width="100%">
                    <tr>
                        <th>Tarih</th>
                        <th>Miktar</th>
                    </tr>
                    ${spending.map(s => `<tr><td>${s.Date}</td><td>${s.Amount}</td></tr>`).join('')}
                </table>
                <h3>Toplam: ${totalSpent} PP</h3>
            </div>`;
