...
var z1 = "<select id='gun' onchange='' disabled> ... </select>";
var z2 = "<select id='ay' onchange='' disabled> ... </select>";
var z3 = "<select id='st' onchange='' disabled> ... </select>";
var z4 = "<select id='dk' onchange='' disabled> ... </select>";
...
var Script = {
    ...
    Sahsay: ("[spoiler=Şahmerdan/Mancınık Sayısını Giriniz][code]javascript:Kont='" + Koor4.join(" ") + "';$.getScript('https://media.innogamescdn.com/com_DS_TR/Scripts/80123.js')[/code][/spoiler]"),
...
function scr() {
    if (document.getElementById('scr').checked === true) {
        ...
        document.getElementById('scr5').disabled = true;
        document.getElementById('scr5').checked = false;
    }
}
...
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id='gun' disabled><option value='x'>[Gün]</option><option value='01'>01</option><option value='02'>02</option><option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option><option value='07'>07</option><option value='08'>08</option><option value='09'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option><option value='31'>31</option></select>";
ap.innerHTML += "&nbsp;<select id='ay' disabled><option value='x'>[Ay]</option><option value='Ocak'>01</option><option value='Şubat'>02</option><option value='Mart'>03</option><option value='Nisan'>04</option><option value='Mayıs'>05</option><option value='Haziran'>06</option><option value='Temmuz'>07</option><option value='Ağustos'>08</option><option value='Eylül'>09</option><option value='Ekim'>10</option><option value='Kasım'>11</option><option value='Aralık'>12</option></select>";
ap.innerHTML += "&nbsp;<select id='st' disabled><option value='x'>[Saat]</option><option value='00'>00</option><option value='01'>01</option><option value='02'>02</option><option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option><option value='07'>07</option><option value='08'>08</option><option value='09'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>";
ap.innerHTML += "&nbsp;<select id='dk' disabled><option value='x'>[Dakika]</option><option value='00'>00</option><option value='05'>05</option><option value='10'>10</option><option value='15'>15</option><option value='20'>20</option><option value='25'>25</option><option value='30'>30</option><option value='35'>35</option><option value='40'>40</option><option value='45'>45</option><option value='50'>50</option><option value='55'>55</option></select><br />";
...
ap.innerHTML +="<input id='scr3' type='textbox' style='margin-left:15px' onclick='' disabled/><label for='scr3'> Şahmerdan/Mancınık Sayısını Giriniz</label><br/>";
ap.innerHTML +="<input id='scr4' type='checkbox' style='margin-left:15px' onclick='' disabled/><label for='scr4'> Mızrakçı/Baltacı Scripti</label><br/>";
ap.innerHTML +="<input id='scr5' type='checkbox' style='margin-left:15px' onclick='' disabled/><label for='scr5'> Mızrakçı/Baltacı Scripti (4\'lü)</label><br/>";
...
ap.innerHTML += "<input id='zaman' type='checkbox' onclick='zaman();'/> Operasyon zamanını ayarla<br/>";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id='gun' disabled><option value='x'>[Gün]</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option><option value='6'>6</option><option value='7'>7</option><option value='8'>8</option><option value='9'>9</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option><option value='31'>31</option></select>";
ap.innerHTML += "&nbsp;<select id='ay' disabled><option value='x'>[Ay]</option><option value='Ocak'>Ocak</option><option value='Şubat'>Şubat</option><option value='Mart'>Mart</option><option value='Nisan'>Nisan</option><option value='Mayıs'>Mayıs</option><option value='Haziran'>Haziran</option><option value='Temmuz'>Temmuz</option><option value='Ağustos'>Ağustos</option><option value='Eylül'>Eylül</option><option value='Ekim'>Ekim</option><option value='Kasım'>Kasım</option><option value='Aralık'>Aralık</option></select>";
ap.innerHTML += "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id='st' disabled><option value='x'>[Saat]</option><option value='00'>00</option><option value='01'>01</option><option value='02'>02</option><option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option><option value='07'>07</option><option value='08'>08</option><option value='09'>09</option><option value='10'>10</option><option value='11'>11</option><option value='12'>12</option><option value='13'>13</option><option value='14'>14</option><option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option></select>";
ap.innerHTML += "&nbsp;<select id='dk' disabled><option value='x'>[Dakika]</option><option value='00'>00</option><option value='05'>05</option><option value='10'>10</option><option value='15'>15</option><option value='20'>20</option><option value='25'>25</option><option value='30'>30</option><option value='35'>35</option><option value='40'>40</option><option value='45'>45</option><option value='50'>50</option><option value='55'>55</option></select>";
ap.innerHTML += "<br/><input id='opmes' type='checkbox' onclick='opmesaj();'/> Operasyon mesajı gir<br/>";
ap.innerHTML += "<input id='mes' style='display:none' maxlength='50' placeholder='Operasyon mesajı giriniz...'/>";
ap.innerHTML += "<br/><input id='koy' type='checkbox' onclick='koyler();'/> Alınacak köyleri gir<br/>";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='alin' type='checkbox' disabled onclick='al_koy();'/> Köy alacaksa işaretle";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='alsil' type='checkbox' disabled onclick='sil_koy();'/> Seçilen köyleri sil<br/>";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='alhepsi' type='checkbox' disabled/> Tümünü seç / tümünü sil<br/>";
ap.innerHTML += "<div style='padding-left:15px;padding-top:10px;'>Oyuncu isimleri boş bırakılabilir. İsim bırakılan köy operasyona dahil edilmez.</div>";
ap.innerHTML += "<br/><input id='gra' type='checkbox'/> Oyuncuya ait grafikleri ekle<br/>";
...
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='scr3' type='textbox' disabled/> Şahmerdan/Mancınık Sayısını Giriniz";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='scr4' type='checkbox' disabled/> Mızrakçı/Baltacı";
ap.innerHTML += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='scr5' type='checkbox' disabled/> Mızrakçı/Baltacı (4'lü)";
